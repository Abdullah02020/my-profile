...
function ExprienceAR() {
  return (
    <div className="ex section__padding">
      ...
      {/* شهادة ميتا لتطوير واجهات الأمامية */}
      <div className="ex__box" data-aos="fade-up">
        <p className="date">2024</p>
        <div className="box__det">
          <h1 className="job-title">
            شهادة محترف تطوير واجهات الأمامية من ميتا
          </h1>
          <p className="jop-sup">ميتا</p>
          <p className="job-dec">
            حصلت على شهادة محترف تطوير واجهات الأمامية من ميتا في عام 2024، ما
            يؤكد خبرتي في تقنيات وأفضل الممارسات في مجال تطوير واجهات الويب
            الأمامية. تعتبر هذه الشهادة دليلاً على قدرتي على بناء تطبيقات ويب
            حديثة وديناميكية، وتساهم بشكل كبير في نموي المهني ومجموعة مهاراتي.
          </p>
        </div>
      </div>
    </div>
